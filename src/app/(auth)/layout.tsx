export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="grid min-h-screen bg-[var(--navy)] lg:grid-cols-[1.05fr_0.95fr]">
      ...
      <section className="grid place-items-center bg-[var(--surface)] p-6 sm:p-10"><div className="w-full max-w-md rounded-2xl border border-[var(--line)] bg-white p-7 shadow-xl shadow-black/5 sm:p-9">{children}</div></section>
    </main>
  );
}
