...
export async function GET() {
  ...
  const rows = [
    ...
    ...inspections.map((inspection) => [inspection.code, inspection.activity.name, inspection.worker.name, inspection.worker.email, inspection.status, inspection._count.items, inspection._count.evidence, inspection.createdAt, inspection.completedAt]),
  ];
